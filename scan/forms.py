...
class	FilterScanListForm(forms.Form):
	...
	#shipper		= forms.ModelChoiceField(queryset=Org.objects.all().order_by('name'), label=u'Поставщик', required=False, widget=AutoCompleteWidget(url='/custom-json-query', initial_display='John Smith'))
